...
export const SKILL_CATEGORIES: {
  ...
  {
    id: "civic",
    label: "Public information habits",
    summary: "Read original documents carefully, label uncertainty, and study how claims get made.",
  },
  {
    id: "content",
...
export const AOS_SKILLS: AosSkill[] = [
  skill({
    ...
    lensPrompt:
      "Tutoring overlay: clarify scope and intent, require evidence strength, flag narrative risk, label claims as evidence/inference/assumption, and keep answers auditable. Route sub-questions to the right educational frame. Educational only — no place-specific legal advice.",
  ...
  skill({
    ...
    lensPrompt:
      "For every major claim: label Evidence, Inference, or Assumption; note source strength; assign confidence; surface conflicts. Never present inference as evidence. Educational claim hygiene only.",
  ...
  skill({
    ...
    name: "Public Info Coach",
    category: "civic",
    path: "skills/civic-intelligence/civic-intelligence-coordinator",
    purpose: "Guide public-information learning from a plain question to careful sources.",
    tutorRole: "Hub for literacy lessons: original documents, honest uncertainty, clear notes.",
    lensPrompt:
      "Coordinate public-information tutoring: prefer primary sources, transparent uncertainty, and educational frames. Do not invent place-specific rules or name real municipalities.",
    askPrompt: "Help me work this carefully: what documents matter, and what can we actually know?",
    goodFor: ["Media literacy pair", "Source habits", "Trade paperwork literacy"],
    industries: ["civic-intelligence", "construction", "law-enforcement"],
    tier: "domain",
  }),
  skill({
    id: "permit-coordinator",
    name: "Approval Path Basics",
    category: "civic",
    path: "skills/civic-intelligence/permit-coordinator",
    purpose: "Learn the general idea of apply → review → conditions → check — education only, not advice for any place.",
    tutorRole: "Maps common approval-journey steps without inventing local rules.",
    lensPrompt:
      "Teach general approval-path reasoning (apply, review, conditions, inspection-style checks). Always label general education vs anything place-specific. Never invent local rules or code numbers.",
    askPrompt: "Walk me through a typical approval path for this kind of work and where people usually get stuck (general education only).",
    goodFor: ["Construction", "Licensing concepts (general)", "Paperwork literacy"],
  ...
  skill({
    ...
    purpose: "Understand that different groups can own different decisions — and that you should not invent who is in charge.",
    tutorRole: "Teaches careful 'who decides' thinking with explicit unknowns.",
    lensPrompt:
      "Explain in plain language that authority can be layered or split. Prefer general education. Flag unknowns. Do not invent agencies, places, or binding rules.",
    askPrompt: "Help me think carefully about who might decide this, and what I still do not know.",
    goodFor: ["Org literacy", "Trade handoffs", "Public info track"],
    industries: ["civic-intelligence", "cdl", "energy", "construction"],
    tier: "domain",
  }),
  skill({
    id: "public-records-forensics",
    name: "Reading Original Documents",
    category: "civic",
    path: "skills/civic-intelligence/public-records-forensics",
    purpose: "How to read applications, contracts, and minutes carefully and honestly.",
    tutorRole: "Teaches method and red flags — not illegal access or harassment.",
    lensPrompt:
      "Teach document-reading methods: what kinds of files exist, how to read carefully, what gaps look like, and how to cite. Lawful, educational learning only. No place names required.",
    askPrompt: "Teach me how to read this kind of original document and what to watch for.",
    goodFor: ["Source habits", "Accounting trails", "Investigative literacy"],
  ...
  skill({
    ...
    purpose: "Build a clean study pack of sources, gaps, and findings.",
    tutorRole: "Project mode: assemble a study-ready source kit structure.",
    lensPrompt:
      "Help the learner build a source pack: inventory of documents, claim chain, gap list, and presentation outline. Educational template only. No targeting private people.",
    askPrompt: "Help me build a source pack: documents, claim chain, gaps, and how to present it.",
    goodFor: ["Capstones", "Study projects", "QA audits"],
  ...
  skill({
    ...
    purpose: "Map organizations and public relationships with evidence on every link.",
    tutorRole: "Network thinking for learning — no private targeting.",
    lensPrompt:
      "Teach relationship-mapping as analysis: organizations, public roles, documented links, with evidence for each edge. Public information norms only.",
    askPrompt: "Map the public relationships here, with evidence for each link.",
    goodFor: ["Org analysis", "Media literacy", "Project stakeholders"],
    industries: ["civic-intelligence", "media-literacy", "project-management"],
    tier: "domain",
  }),
  skill({
    id: "construction-oversight",
    name: "Jobsite Quality Eye",
    category: "civic",
    path: "skills/civic-intelligence/construction-oversight",
    purpose: "See construction work through documentation, quality, and life-safety habits.",
    tutorRole: "Pairs with trades tutoring for quality and safety mindset.",
    lensPrompt:
      "Teach jobsite quality habits: checks, common defects, documentation quality, and safety. Emphasize life-safety. Not a substitute for a licensed inspector.",
    askPrompt: "Coach me on what good jobsite quality checks look like for this situation.",
  ...
  skill({
    ...
    name: "Rule-Finding Compass",
    category: "civic",
    path: "skills/civic-intelligence/regulatory-routing-engine",
    purpose: "When a rules question feels tangled, find the right kind of document to study — not invent the rule.",
    tutorRole: "Helps you pick an educational frame when paperwork is confusing.",
    lensPrompt:
      "Route the learner's rules question to a general educational frame (what kind of document, what kind of organization). State uncertainty. Never invent place-specific rules.",
    askPrompt: "Where should I look first for this kind of rule, and what kind of document am I hunting? (general education)",
    goodFor: ["Paperwork literacy", "Licensing concepts (general)", "Utilities basics"],
    industries: ["civic-intelligence", "energy", "construction"],
    tier: "domain",
  }),
  skill({
    id: "assessor-enrichment",
    name: "Property Record Literacy",
    category: "civic",
    path: "skills/civic-intelligence/assessor-enrichment",
    purpose: "Read property-style public tables carefully without overclaiming.",
    tutorRole: "Teaches careful interpretation of common fields and pitfalls.",
    lensPrompt:
      "Teach how to read property-style public data fields carefully, common pitfalls, and claim labeling. Educational only. No real addresses or place targeting.",
    askPrompt: "Help me read this property-style table carefully and label what we can claim.",
    goodFor: ["Data literacy", "Accounting pair"],
  ...
  skill({
    ...
    purpose: "Handle incident-style data with clear limits, missingness, and bias.",
    tutorRole: "Statistics literacy for safety-style datasets.",
    lensPrompt:
      "Define fields, missingness, selection bias, and what conclusions the data can and cannot support. Educational statistics literacy only.",
    askPrompt: "Teach me what this incident dataset can and cannot support as a conclusion.",
    goodFor: ["Data literacy", "Safety education"],
    industries: ["data", "civic-intelligence", "law-enforcement", "cdl"],
    tier: "domain",
  }),
  skill({
    id: "state-onboarding-playbook",
    name: "New Context Study Pack",
    category: "civic",
    path: "skills/civic-intelligence/state-onboarding-playbook",
    purpose: "Build a study pack when you are learning a new workplace or place context — without inventing local law.",
    tutorRole: "Template for agencies-in-general, open data habits, and records norms.",
    lensPrompt:
      "Help the learner build a context study pack: kinds of organizations, kinds of primary documents, open data habits. Template-driven education. Do not invent place-specific statutes.",
    askPrompt: "Help me build a learning pack for a new context: organizations, primary documents, open data habits.",
    goodFor: ["Relocating professionals", "Researchers", "Project setup"],
